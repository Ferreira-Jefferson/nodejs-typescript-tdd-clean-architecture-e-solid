...
import { fakeAuthenticationParams } from '@/domain/test'
import { stubHashComparer, stubEncrypter, stubLoadAccountByEmailRepository, stubUpdateAccessTokenRepository } from '@/data/test'
...
const makeSut = (): SutTypes => {
  ...
  const hashComparerStub = stubHashComparer()
  const encrypterStub = stubEncrypter()
  const updateAccessTokenRepositoryStub = stubUpdateAccessTokenRepository()
