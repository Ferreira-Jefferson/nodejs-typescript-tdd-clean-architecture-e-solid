...
import { stubDecrypter, stubLoadAccountByTokenRepository } from '@/data/test'
...
const makeSut = (): SutTypes => {
  const decrypterStub = stubDecrypter()
  const loadAccountByTokenRepositoryStub = stubLoadAccountByTokenRepository()
...
describe('DbLoadAccountByToken Usecase', () => {
  ...
  test('Should call LoadAccountByTokenRepository with correct values', async () => {
    ...
    await sut.load('any_token', 'any_role')
    expect(decryptSpy).toBeCalledWith('any_token', 'any_role')
  })
